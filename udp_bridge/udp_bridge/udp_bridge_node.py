...
class UdpBridgeNode(Node):
    def __init__(self) -> None:
        ...
        self.autoaim_pub = self.create_publisher(AutoAIM, "/autoaim/target", pub_qos)

        self.joint_sub = self.create_subscription(
            JointState, "/joint_states", self._on_joint_states, sub_qos
        )
        self.autoaim_sub = self.create_subscription(
            AutoAIM, "/autoaim/target", self._on_autoaim_target, sub_qos
        )
