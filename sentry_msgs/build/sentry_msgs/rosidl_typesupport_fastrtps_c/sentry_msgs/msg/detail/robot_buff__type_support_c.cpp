...
#include "sentry_msgs/msg/detail/robot_buff__rosidl_typesupport_fastrtps_c.h"
...
using _RobotBuff__ros_msg_type = sentry_msgs__msg__RobotBuff;
...
size_t get_serialized_size_sentry_msgs__msg__RobotBuff(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotBuff__ros_msg_type * ros_message = static_cast<const _RobotBuff__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RobotBuff__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sentry_msgs__msg__RobotBuff(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sentry_msgs
size_t max_serialized_size_sentry_msgs__msg__RobotBuff(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentry_msgs__msg__RobotBuff;
    is_plain =
      (
...
static size_t _RobotBuff__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sentry_msgs__msg__RobotBuff(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sentry_msgs, msg, RobotBuff)() {
