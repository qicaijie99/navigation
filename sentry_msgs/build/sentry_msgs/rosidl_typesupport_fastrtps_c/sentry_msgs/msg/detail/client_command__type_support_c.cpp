...
#include "sentry_msgs/msg/detail/client_command__rosidl_typesupport_fastrtps_c.h"
...
using _ClientCommand__ros_msg_type = sentry_msgs__msg__ClientCommand;
...
size_t get_serialized_size_sentry_msgs__msg__ClientCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ClientCommand__ros_msg_type * ros_message = static_cast<const _ClientCommand__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ClientCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sentry_msgs__msg__ClientCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sentry_msgs
size_t max_serialized_size_sentry_msgs__msg__ClientCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentry_msgs__msg__ClientCommand;
    is_plain =
      (
...
static size_t _ClientCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sentry_msgs__msg__ClientCommand(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sentry_msgs, msg, ClientCommand)() {
