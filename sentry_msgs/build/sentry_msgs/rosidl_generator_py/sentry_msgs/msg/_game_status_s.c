...
bool sentry_msgs__msg__game_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentry_msgs.msg._game_status.GameStatus", full_classname_dest, 39) == 0);
  }
  sentry_msgs__msg__GameStatus * ros_message = _ros_message;
  {  // header
...
PyObject * sentry_msgs__msg__game_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentry_msgs.msg._game_status");
