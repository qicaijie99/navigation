...
bool sentry_msgs__msg__shoot_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentry_msgs.msg._shoot_data.ShootData", full_classname_dest, 37) == 0);
  }
  sentry_msgs__msg__ShootData * ros_message = _ros_message;
  {  // header
...
PyObject * sentry_msgs__msg__shoot_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentry_msgs.msg._shoot_data");
