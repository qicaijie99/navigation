...
#ifndef SENTRY_MSGS__MSG__DETAIL__CLIENT_COMMAND__TRAITS_HPP_
#define SENTRY_MSGS__MSG__DETAIL__CLIENT_COMMAND__TRAITS_HPP_
...
inline void to_yaml(
  const sentry_msgs::msg::ClientCommand & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sentry_msgs::msg::ClientCommand & msg)
{
  return sentry_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sentry_msgs::msg::ClientCommand>()
{
  return "sentry_msgs::msg::ClientCommand";
}

template<>
inline const char * name<sentry_msgs::msg::ClientCommand>()
{
  return "sentry_msgs/msg/ClientCommand";
}

template<>
struct has_fixed_size<sentry_msgs::msg::ClientCommand>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sentry_msgs::msg::ClientCommand>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sentry_msgs::msg::ClientCommand>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SENTRY_MSGS__MSG__DETAIL__CLIENT_COMMAND__TRAITS_HPP_
