...
#ifndef SENTRY_MSGS__MSG__DETAIL__DUAL_LOOP_PID__STRUCT_HPP_
#define SENTRY_MSGS__MSG__DETAIL__DUAL_LOOP_PID__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sentry_msgs__msg__DualLoopPID __attribute__((deprecated))
#else
# define DEPRECATED__sentry_msgs__msg__DualLoopPID __declspec(deprecated)
#endif
...
struct DualLoopPID_
{
  ...
  // pointer types
  using RawPtr =
    sentry_msgs::msg::DualLoopPID_<ContainerAllocator> *;
  using ConstRawPtr =
    const sentry_msgs::msg::DualLoopPID_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sentry_msgs::msg::DualLoopPID_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sentry_msgs__msg__DualLoopPID
    std::shared_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sentry_msgs__msg__DualLoopPID
    std::shared_ptr<sentry_msgs::msg::DualLoopPID_<ContainerAllocator> const>
...
using DualLoopPID =
  sentry_msgs::msg::DualLoopPID_<std::allocator<void>>;
...
#endif  // SENTRY_MSGS__MSG__DETAIL__DUAL_LOOP_PID__STRUCT_HPP_
