...
#ifndef SENTRY_MSGS__MSG__DETAIL__DUAL_LOOP_PID__TRAITS_HPP_
#define SENTRY_MSGS__MSG__DETAIL__DUAL_LOOP_PID__TRAITS_HPP_
...
inline void to_yaml(
  const sentry_msgs::msg::DualLoopPID & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sentry_msgs::msg::DualLoopPID & msg)
{
  return sentry_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sentry_msgs::msg::DualLoopPID>()
{
  return "sentry_msgs::msg::DualLoopPID";
}

template<>
inline const char * name<sentry_msgs::msg::DualLoopPID>()
{
  return "sentry_msgs/msg/DualLoopPID";
}

template<>
struct has_fixed_size<sentry_msgs::msg::DualLoopPID>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sentry_msgs::msg::DualLoopPID>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sentry_msgs::msg::DualLoopPID>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SENTRY_MSGS__MSG__DETAIL__DUAL_LOOP_PID__TRAITS_HPP_
