...
#include "sentry_msgs/msg/detail/dual_loop_pid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sentry_msgs::msg::DualLoopPID & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentry_msgs::msg::DualLoopPID & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentry_msgs::msg::DualLoopPID;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sentry_msgs::msg::DualLoopPID *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentry_msgs::msg::DualLoopPID *>(
    untyped_ros_message);
...
{
  return &sentry_msgs::msg::typesupport_fastrtps_cpp::_DualLoopPID__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentry_msgs, msg, DualLoopPID)() {
  return &sentry_msgs::msg::typesupport_fastrtps_cpp::_DualLoopPID__handle;
}
