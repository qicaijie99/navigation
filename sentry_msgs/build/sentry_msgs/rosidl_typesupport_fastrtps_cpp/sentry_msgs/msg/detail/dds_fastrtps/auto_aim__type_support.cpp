...
#include "sentry_msgs/msg/detail/auto_aim__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sentry_msgs::msg::AutoAIM & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sentry_msgs::msg::AutoAIM & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sentry_msgs::msg::AutoAIM;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sentry_msgs::msg::AutoAIM *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sentry_msgs::msg::AutoAIM *>(
    untyped_ros_message);
...
{
  return &sentry_msgs::msg::typesupport_fastrtps_cpp::_AutoAIM__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentry_msgs, msg, AutoAIM)() {
  return &sentry_msgs::msg::typesupport_fastrtps_cpp::_AutoAIM__handle;
}
