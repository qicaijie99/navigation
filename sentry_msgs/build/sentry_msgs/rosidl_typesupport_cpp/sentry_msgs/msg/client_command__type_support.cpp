...
static const _ClientCommand_type_support_symbol_names_t _ClientCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentry_msgs, msg, ClientCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sentry_msgs, msg, ClientCommand)),
  }
};
...
{
  return &::sentry_msgs::msg::rosidl_typesupport_cpp::ClientCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sentry_msgs, msg, ClientCommand)() {
  return get_message_type_support_handle<sentry_msgs::msg::ClientCommand>();
}
