...
static const _AutoAIM_type_support_symbol_names_t _AutoAIM_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sentry_msgs, msg, AutoAIM)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sentry_msgs, msg, AutoAIM)),
  }
};
...
{
  return &::sentry_msgs::msg::rosidl_typesupport_cpp::AutoAIM_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sentry_msgs, msg, AutoAIM)() {
  return get_message_type_support_handle<sentry_msgs::msg::AutoAIM>();
}
