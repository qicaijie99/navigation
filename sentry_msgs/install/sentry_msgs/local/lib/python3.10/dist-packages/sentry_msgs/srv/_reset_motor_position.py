...
class Metaclass_ResetMotorPosition(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'sentry_msgs.srv.ResetMotorPosition')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from sentry_msgs.srv import _reset_motor_position
...
class ResetMotorPosition(metaclass=Metaclass_ResetMotorPosition):
    from sentry_msgs.srv._reset_motor_position import ResetMotorPosition_Request as Request
    from sentry_msgs.srv._reset_motor_position import ResetMotorPosition_Response as Response
