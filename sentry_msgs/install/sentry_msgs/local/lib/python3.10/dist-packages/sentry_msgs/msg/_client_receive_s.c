...
bool sentry_msgs__msg__client_receive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentry_msgs.msg._client_receive.ClientReceive", full_classname_dest, 45) == 0);
  }
  sentry_msgs__msg__ClientReceive * ros_message = _ros_message;
  {  // header
...
PyObject * sentry_msgs__msg__client_receive__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentry_msgs.msg._client_receive");
