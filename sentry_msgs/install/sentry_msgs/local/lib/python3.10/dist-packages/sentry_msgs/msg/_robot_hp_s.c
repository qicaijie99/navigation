...
bool sentry_msgs__msg__robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sentry_msgs.msg._robot_hp.RobotHP", full_classname_dest, 33) == 0);
  }
  sentry_msgs__msg__RobotHP * ros_message = _ros_message;
  {  // header
...
PyObject * sentry_msgs__msg__robot_hp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sentry_msgs.msg._robot_hp");
