...
sentry_msgs__msg__DualLoopPIDWithFilter__init(sentry_msgs__msg__DualLoopPIDWithFilter * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sentry_msgs__msg__DualLoopPIDWithFilter__fini(msg);
    return false;
  }
  // inner_kp
  // inner_ki
...
sentry_msgs__msg__DualLoopPIDWithFilter__create()
{
  ...
  sentry_msgs__msg__DualLoopPIDWithFilter * msg = (sentry_msgs__msg__DualLoopPIDWithFilter *)allocator.allocate(sizeof(sentry_msgs__msg__DualLoopPIDWithFilter), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sentry_msgs__msg__DualLoopPIDWithFilter));
  bool success = sentry_msgs__msg__DualLoopPIDWithFilter__init(msg);
  if (!success) {
...
sentry_msgs__msg__DualLoopPIDWithFilter__Sequence__init(sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentry_msgs__msg__DualLoopPIDWithFilter * data = NULL;

  if (size) {
    data = (sentry_msgs__msg__DualLoopPIDWithFilter *)allocator.zero_allocate(size, sizeof(sentry_msgs__msg__DualLoopPIDWithFilter), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sentry_msgs__msg__DualLoopPIDWithFilter__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sentry_msgs__msg__DualLoopPIDWithFilter__fini(&data[i - 1]);
      }
...
sentry_msgs__msg__DualLoopPIDWithFilter__Sequence__fini(sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sentry_msgs__msg__DualLoopPIDWithFilter__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * array = (sentry_msgs__msg__DualLoopPIDWithFilter__Sequence *)allocator.allocate(sizeof(sentry_msgs__msg__DualLoopPIDWithFilter__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sentry_msgs__msg__DualLoopPIDWithFilter__Sequence__init(array, size);
  if (!success) {
...
sentry_msgs__msg__DualLoopPIDWithFilter__Sequence__destroy(sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sentry_msgs__msg__DualLoopPIDWithFilter__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sentry_msgs__msg__DualLoopPIDWithFilter__Sequence__are_equal(const sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * lhs, const sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sentry_msgs__msg__DualLoopPIDWithFilter__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sentry_msgs__msg__DualLoopPIDWithFilter__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sentry_msgs__msg__DualLoopPIDWithFilter);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sentry_msgs__msg__DualLoopPIDWithFilter * data =
      (sentry_msgs__msg__DualLoopPIDWithFilter *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sentry_msgs__msg__DualLoopPIDWithFilter__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sentry_msgs__msg__DualLoopPIDWithFilter__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sentry_msgs__msg__DualLoopPIDWithFilter__copy(
