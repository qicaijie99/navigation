...
namespace small_point_lio {
    ...
    private:
        ...
        std::vector<Eigen::Vector3f> pointcloud_body_frame;
        std::function<void(const std::vector<Eigen::Vector3f> &pointcloud)> pointcloud_callback;
        std::function<void(const std::vector<Eigen::Vector3f> &pointcloud)> pointcloud_body_callback;
    ...
    public:
        ...
        void set_pointcloud_body_callback(const std::function<void(const std::vector<Eigen::Vector3f> &pointcloud)> &pointcloud_body_callback);
