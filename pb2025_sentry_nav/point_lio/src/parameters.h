...
extern bool multi_lidar_enabled;
extern int multi_lidar_count;
extern std::vector<double> extrinT_lidar0;
extern std::vector<double> extrinR_lidar0;
extern std::vector<double> extrinT_lidar1;
extern std::vector<double> extrinR_lidar1;
