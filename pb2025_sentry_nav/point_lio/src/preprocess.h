...
enum LID_TYPE { AVIA = 1, VELO16, OUST64, HESAIxt32, LIVOX_PCL2 };  //{1, 2, 3, 4}
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void avia_handler_pc2(const sensor_msgs::msg::PointCloud2::SharedPtr &msg);
